...
export default function KanbanColumn() {
  ...
  return (
    <div className="mt-8 flex-1 overflow-x-auto">
              ...
              <div className="mb-3 flex justify-between rounded-lg border border-gray-700 p-3">
                ...
                <div>
                  <button
                    ...
                    className="right-6 top-6 inline-flex items-center gap-2 rounded-lg bg-blue-400/10 px-3 py-1.5 text-xs font-medium text-blue-500 transition-colors hover:bg-blue-600 hover:text-white"
                  >
                    ＋
                  </button>
                </div>
      ...
      {showForm && <KanbanItemForm onClose={handleCloseForm} />}
    </div>
  );
}
